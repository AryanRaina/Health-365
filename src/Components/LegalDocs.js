  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Health <span className="legal-siteSign">365</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Health 365, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Health 365, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Health 365 is designed to simplify healthcare access. You can choose
